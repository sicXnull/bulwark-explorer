![POSQ Logo](https://posqcrypto.com/wp-content/uploads/2018/04/blockexplorer.svg)

POSQ Explorer
&middot;
[![GitHub license](https://img.shields.io/github/license/posq-crypto/posq-explorer.svg)](https://github.com/posq-crypto/posq-explorer/blob/master/COPYING) [![Build Status](https://travis-ci.org/posq-crypto/posq-explorer.svg?branch=master)](https://travis-ci.org/posq-crypto/posq-explorer) [![Discord](https://img.shields.io/discord/374271866308919296.svg)](https://discord.me/posqcrypto) [![GitHub version](https://badge.fury.io/gh/posq-crypto%2Fposq-explorer.svg)](https://badge.fury.io/gh/posq-crypto%2Fposq-explorer)
=====
...
It is also required to have the POSQ daemon running in the background. It is recommended to set this up before beginning to set up the explorer so that it syncs by the time you need it.

Our geniuses here at POSQCorp™ have put together a script to do this for you. Just run

`bash script/posqd_setup.sh`

This will install the latest POSQ wallet and create a rpc username/password before starting the daemon.

## Install
`git clone https://github.com/posq-crypto/posq-explorer.git` - copy repo to local folder.
